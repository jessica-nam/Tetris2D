//stores static data to be used throughout game
...
public static class Data
{
    ...
    //cells - dictionary(key value pairing) - for every key(Tetromino piece), we specify the respective array of cells
